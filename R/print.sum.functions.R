...
#'
#' @return
#' A data frame of summary nodesplit results with the following variables:
#' * `Comparison` The treatment comparison on which a nodesplit has been performed
#' * `Time.Param` The time-course parameter on which a nodesplit has been performed
