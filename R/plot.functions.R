...
#'   observations (therefore the darkest shaded color) only used if displ.obs is
...
#' of the object can therefore be ammended as with other plots generated by `ggplot()`.
...
#' time=0.
#'
#' @details Plots can be facetted by either treatment (`level="treatment"`) or class
