...
* $\mu_i$ is the study reference effect (modelled as a nuisance parameter) in study $i$. Where only a single time-course parameter is modelled using relative effects the prior is defined as $\mu_{i} \sim N(0,10000)$.
