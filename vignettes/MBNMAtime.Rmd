...
load(system.file("extdata", "umelist.1.RData", package="MBNMAtime"))
...
load(system.file("extdata", "nodesplit.1.RData", package="MBNMAtime"))
```
```{r}
print(nodesplit)
```
...
load(system.file("extdata", "nodesplit.2.RData", package="MBNMAtime"))
```
